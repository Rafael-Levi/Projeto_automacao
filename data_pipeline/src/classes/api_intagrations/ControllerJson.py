...
class APIClientJson(APIClient):
    ...
    def populate_table(self,table_name: str):
        try:
            # Carregar o CSV
            data_frame = pd.read_json(self.file_path_json)
    ...
    def create_and_populate_json(self,table_name_input:str):
        self.create_table(table_name=table_name_input)
        self.populate_table(table_name=table_name_input)  